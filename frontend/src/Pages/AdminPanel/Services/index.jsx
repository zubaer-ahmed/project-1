...
const deleteEndpoint = import.meta.env.VITE_BASE_URL + "/api/services/deleteService";
const readEndpoint = import.meta.env.VITE_BASE_URL + "/api/services/getServices";
const updateEndpoint = import.meta.env.VITE_BASE_URL + "/api/services/updateService";
